				...
				<MkFolder>
					...
					<div class="_gaps_s">
						...
						<MkFolder v-if="matchQuery([i18n.ts._role._options.canCreateCustomEmojiApplications, 'canCreateCustomEmojiApplications'])">
							...
							<template #suffix>{{ policies.canCreateCustomEmojiApplications ? i18n.ts.yes : i18n.ts.no }}</template>
							<MkSwitch v-model="policies.canCreateCustomEmojiApplications">
								<template #label>{{ i18n.ts.enable }}</template>
							</MkSwitch>
						</MkFolder>
						...
						<MkFolder v-if="matchQuery([i18n.ts._role._options.canCreateAvatarDecorationApplications, 'canCreateAvatarDecorationApplications'])">
							...
							<template #suffix>{{ policies.canCreateAvatarDecorationApplications ? i18n.ts.yes : i18n.ts.no }}</template>
							<MkSwitch v-model="policies.canCreateAvatarDecorationApplications">
								<template #label>{{ i18n.ts.enable }}</template>
							</MkSwitch>
						</MkFolder>
