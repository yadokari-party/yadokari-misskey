...
export type AdminEmojiApplicationAcceptRequest = operations['admin___emoji-application___accept']['requestBody']['content']['application/json'];
export type AdminEmojiApplicationAcceptResponse = operations['admin___emoji-application___accept']['responses']['200']['content']['application/json'];
export type AdminEmojiApplicationRejectRequest = operations['admin___emoji-application___reject']['requestBody']['content']['application/json'];
export type AdminEmojiApplicationRejectResponse = operations['admin___emoji-application___reject']['responses']['200']['content']['application/json'];
...
export type EmojiApplicationShowRequest = operations['emoji-application___show']['requestBody']['content']['application/json'];
export type EmojiApplicationShowResponse = operations['emoji-application___show']['responses']['200']['content']['application/json'];
export type EmojiApplicationCreateRequest = operations['emoji-application___create']['requestBody']['content']['application/json'];
export type EmojiApplicationCreateResponse = operations['emoji-application___create']['responses']['200']['content']['application/json'];
export type EmojiApplicationUpdateRequest = operations['emoji-application___update']['requestBody']['content']['application/json'];
export type EmojiApplicationUpdateResponse = operations['emoji-application___update']['responses']['200']['content']['application/json'];
export type EmojiApplicationCancelRequest = operations['emoji-application___cancel']['requestBody']['content']['application/json'];
export type EmojiApplicationCancelResponse = operations['emoji-application___cancel']['responses']['200']['content']['application/json'];
