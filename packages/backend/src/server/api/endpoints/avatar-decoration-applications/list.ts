...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			const query = queryService.makePaginationQuery(avatarDecorationApplicationsRepository.createQueryBuilder('avatarDecorationApplication'), ps.sinceId, ps.untilId)
				.andWhere('avatarDecorationApplication.userId = :userId', { userId: me.id });
